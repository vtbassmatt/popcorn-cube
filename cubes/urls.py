...
from .views import CubeCreateView, CubeDetailView, CubeListView, HowThisWorksView, my_submissions, submit_card
...
urlpatterns = [
    ...
    path("cubes/<int:pk>/my-submissions/", my_submissions, name="cube-my-submissions"),
]
